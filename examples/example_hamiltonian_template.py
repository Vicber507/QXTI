"""Copia de referencia de la plantilla de Hamiltoniano para QXTI.

El archivo que QXTI carga por defecto debe vivir en ``models/``.
Esta copia en ``examples/`` es solo para consulta rapida junto al config ejemplo.
"""
